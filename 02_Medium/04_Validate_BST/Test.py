...
class TestProgram(unittest.TestCase):
	...
	def test_case_1(self):
		self.assertEqual(BST.validateBST(test1), True)

	def test_case_2(self):
		self.assertEqual(BST.validateBST(test2), True)

	def test_case_3(self):
		self.assertEqual(BST.validateBST(test3), True)

	def test_case_4(self):
		self.assertEqual(BST.validateBST(test4), True)

	def test_case_5(self):
		self.assertEqual(BST.validateBST(test5), True)

	def test_case_6(self):
		self.assertEqual(BST.validateBST(test6), False)

	def test_case_7(self):
		self.assertEqual(BST.validateBST(test7), False)

	def test_case_8(self):
		self.assertEqual(BST.validateBST(test8), False)

	def test_case_9(self):
		self.assertEqual(BST.validateBST(test9), False)

	def test_case_10(self):
		self.assertEqual(BST.validateBST(test10), False)
