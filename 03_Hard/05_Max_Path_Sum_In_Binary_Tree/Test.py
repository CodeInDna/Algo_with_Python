from Max_Sum_In_Binary_Tree import maxPathSum
import unittest
...
class TestProgram(unittest.TestCase):
    ...
    def test_case_5(self):
        ...
        self.assertEqual(maxPathSum(test), 154)
